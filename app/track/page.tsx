...
export default function TrackPage(){
 ...
 const openToken=()=>{const clean=token.trim();if(!clean){setError('Paste your order tracking code first.');return}window.location.href=`/order/${clean}`};
